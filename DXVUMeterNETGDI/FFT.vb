...
Public Module FFT
    ...
    Public Class ComplexDouble
        ...
        Public Shared Operator ^(n1 As Double, n2 As ComplexDouble) As ComplexDouble
            ...
            Dim ln1 As Double = Log(n1)
            Dim r As Double = ab * Cos(n2.I * ln1)
            Dim i As Double = ab * Sin(n2.I * ln1)
        ...
        Public Shared Function FromDouble(array() As Double) As ComplexDouble()
            Return (From d In array Select FromDouble(d)).ToArray()
        End Function
    ...
    Public Function ToNearestPowerOfTwo(x As Integer) As Integer
        Return Pow(2, Ceiling(Log(x) / Log(2)))
    End Function
