Partial Public Class DXVUMeterNETGDI
    ...
    Public Enum ErrorConstants
        ''' <summary>This exception indicates a problem related to the cursor display under the <see cref="StyleConstants">FFT</see> display mode</summary>
        CursorPosEx
        ''' <summary>This exception indicates that a problem has occurred while trying to initialize the color cache for the leds in the <see cref="StyleConstants">DigitalVU</see> mode</summary>
        DefineColorsEx
